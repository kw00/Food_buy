   ...
   <header id="header_outer">
      <div class="container">
         <div class="header_section">
            <div class="logo">
               <a href="main.jsp"><img src="../../img/logob.png"
                  alt=""></a>
            </div>
            <nav class="nav" id="nav">
               <ul class="toggle">
                                    <li class="active"><a href="cate_input.jsp">Category</a></li>
                  <li><a href="cate_list.jsp">CateList</a></li>
                  <li><a
                     href="<%=request.getContextPath()%>/myshop/admin/prod_input.jsp">Product</a></li>
                  <li><a
                     href="<%=request.getContextPath()%>/myshop/admin/prod_list.jsp">ProductList</a></li>
                  <li><a
                     href="<%=request.getContextPath()%>/myshop/admin/shopping_list.jsp">Search</a></li>
                  <li><a href="<%=request.getContextPath()%>/myshop/admin/prod_portfolio.jsp">Gallary</a></li>
                  <li><a href="#contact">Contact</a></li>
                  <li><a href="../../main.jsp">SignIn</a></li>
                  <li><a
                     href="<%=request.getContextPath()%>/myshop/display/main.jsp">Customer</a></li>
                  <li><a href="../../main.jsp">SignIn</a></li>
                  <li><a class=logout href="<%=request.getContextPath()%>/logout.jsp">logout</a></li>
                  <li></li>      
               </ul>
               <ul class="">
                  <li class="active"><a href="cate_input.jsp">Category</a></li>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont flipInY wow animated">
              <h3>for customers &nbsp;  &amp; &nbsp; Differentiation
              </h3>
              <h2>Welcome to my Shop
                Have a nice day</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="service_block">
            ...
            <h3 class="animated fadeInUp wow">fresh</h3>
            <p class="animated fadeInDown wow">Proin iaculis purus consequat sem cure digni. Donec porttitora entum suscipit  aenean rhoncus posuere odio in tincidunt.</p>
          </div>
        </div>
      </div>
...
<section class="main-section team" id="team"><!--main-section team-start-->
  <div class="container">
    <h2>I highly recommend this web site!</h2>
    ...
    <div class="team-leader-block clearfix">
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-03s">
          ...
          <ul>
            <li><a href="https://twitter.com/gordonramsay" class="fa-twitter"></a></li>
        ...
        <h3 class="wow fadeInDown delay-03s">Gordon Ramsay</h3>
      ...
      <div class="team-leader-box">
        ...
        <h3 class="wow fadeInDown delay-06s">Baek JongWon</h3>
      ...
      <div class="team-leader-box">
        ...
        <h3 class="wow fadeInDown delay-09s">Choi Hyun Seok</h3>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="contact_block">
              ...
              <a href="http://map.naver.com/?query=%EB%8C%80%ED%9D%A5%EB%A1%9C+28%EA%B8%B8+28-4"><span> Mapo-gu, Seoul, Republic of Korea <br>
              28-4, Daeheung-ro 28-gil </span></a> </div>
          </div>
          <div class="col-lg-4">
            <div class="contact_block">
              <div class="contact_block_icon icon2 rollIn animated wow"><span><i class="fa-phone"></i></span></div>
              <span> Park - kyung - woo <br>
              010 - 9445 - 5545 </span> </div>
          </div>
          <div class="col-lg-4">
            <div class="contact_block">
              <div class="contact_block_icon icon3 rollIn animated wow"><span><i class="fa-pencil"></i></span></div>
              <span> <a href="mailto:profyle@naver.com">profyle@naver.com</a> </span> </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          ...
          <ul class="social-link">
            ...
            <li class="facebook animated bounceIn wow delay-03s"><a href="https://www.facebook.com/outcase"><i class="fa-facebook"></i></a></li>
...
<%-- <jsp:include page="bottom.jsp"/> 윗줄 대신 이줄도 가능함--%>
